...
class _DetallePaseadorState extends State<DetallePaseador> {
  ...
  Widget build(BuildContext context) {
    final posicion = CameraPosition(
        target: LatLng(widget.paseador.ubicacion.latitude,
            widget.paseador.ubicacion.longitude),
        zoom: 15);
    ...
    setState(() {
      marcador.add(Marker(
          markerId: MarkerId(widget.paseador.id),
          position: LatLng(widget.paseador.ubicacion.latitude,
              widget.paseador.ubicacion.longitude),
          icon:
