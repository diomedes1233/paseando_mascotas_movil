...
import 'package:paseando_mascotas/modelo/usuario_modelo.dart';
import 'package:paseando_mascotas/pages/login_page.dart';
import 'package:paseando_mascotas/repositorio/usuario_registrar.dart';
import 'dart:convert';
      ...
      if (password.text == passwordConf.text) {
        if (nombres.text.isNotEmpty &&
          ...
          var usuNew = Usuario("", nombres.text, apellidos.text, email.text,
              telefono.text, direccion.text, gen, password.text);
